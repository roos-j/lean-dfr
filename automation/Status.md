...
\label{ext:interpolation}: Proved (Lean: Auto.Twisted.fourVertexMarcinkiewiczUniformMeasurable_of_sigmaFinite proves Auto.Twisted.FourVertexMarcinkiewiczUniformMeasurable for every sigma-finite measure; Auto.Twisted.fourVertexMarcinkiewicz_of_measurable and Auto.Twisted.fourVertexMarcinkiewicz_of_uniformMeasurable give the per-operator form Auto.Twisted.FourVertexMarcinkiewicz. Two hypotheses beyond the recorded statements: sigma-finite mu, and measurable values of the operator on simple triples; the latter is necessary, see ErrorReport. Both hold for Lebesgue measure on E3 and the operators of thm:extended_model.) (2026-09-14T00:35-0700)
