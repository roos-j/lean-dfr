...
in progress | `def:gaussian`–`lem:domination`, lines 297–430 | Exact Gaussian/Fourier/derivative and scaled-kernel identities; exact bracket mass `2/9`; a direct smooth source-compatible frequency bump; `\Psi`, `c_\Psi`, `\Phi`, their cutoff/tail identities, and real-even compact Schwartz Fourier data are kernel-checked. Pointwise domination and superposition remain. | 2026-09-10T21:54:16-07:00
